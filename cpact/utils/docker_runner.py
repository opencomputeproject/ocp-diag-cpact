...
===============================================================================
DockerRunner is a utility class for managing Docker container lifecycle operations
...
- Integrates with TestLogger for consistent logging.
...
Usage:
    Instantiate DockerRunner with step data and index.
    Call `load_docker()` to start the container.
    Use `execute_command()` to run commands inside the container.
    Call `stop_container()` to clean up after execution.
===============================================================================
"""
...
import os
import subprocess
from deprecated_connections.connection_factory import ConnectionFactory
